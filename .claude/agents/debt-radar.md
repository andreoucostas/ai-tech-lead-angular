...
2. Take the caller's input. It is one of: a file path, a list of paths, or a feature-area name (e.g. `auth`, `reporting`).
...
|----|-------|----------|--------|-------|------------------|
| DEBT-NNN | ... | High | S | path/to/foo.ts:42 | Yes — same file as your work |
