...
| Codemap  | CODEMAP.md | 5.1KB | Merge → CLAUDE.md > File Structure |
...
CLAUDE.md will receive:
  ...
  > File Structure ← CODEMAP.md (full content)
...
Merge into CLAUDE.md > File Structure. Preserve diagrams.
