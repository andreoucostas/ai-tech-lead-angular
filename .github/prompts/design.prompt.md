...
Read `CLAUDE.md` (File Structure, Conventions, Architecture Decisions) and `.claude/commands/design.md`, then execute the design workflow defined there for the requirement below.
